...
c42_master='https://sp.code42.mn'
c42_port='4285'
c42_admin='admin'
c42_password='get_from_Marc'        # Come up with a safer method for deployment. Store in file with restricted read access? 
c42_admin_email='todd@code42.com'
